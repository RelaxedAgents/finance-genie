...
[![Google Hackathon](https://img.shields.io/badge/🏆%20Google%20Hackathon-2025%20Winner-gold?style=for-the-badge)](https://github.com/thepm25/google_hackathon_finance_agent)
...
graph TB
    ...
    subgraph "ORCHESTRATOR LAYER"
        ...
        VOICE_PROCESSOR[🎙️ Voice Processor]
    end
    ...
    subgraph "SHARED SERVICES"
        ...
        VOICE_ENGINE[🎙️ Voice Engine<br/>Speech Processing]
    end
    ...
    subgraph "ENHANCED MEMORY LAYER"
        ...
        VOICE_HISTORY[🎙️ Voice Interaction History]
    end
    ...
    subgraph "EXTERNAL SERVICES"
        ...
        SPEECH_API[🎙️ Speech APIs<br/>Voice Processing]
    end
    ...
    VOICE_ROUTES --> VOICE_PROCESSOR
    TRANSFORM_ROUTES --> FINANCE_GENIE
    
    VOICE_PROCESSOR --> FINANCE_GENIE
    ...
    class WEB,MOBILE,VOICE,API_CLIENT clientLayer
    class HEALTH,AGENT_ROUTES,STREAM_ROUTES,VOICE_ROUTES,TRANSFORM_ROUTES apiLayer
    class FINANCE_GENIE,TASK_ROUTER,RESPONSE_SYNTHESIZER,AGENT_COORDINATOR,VOICE_PROCESSOR orchestratorLayer
    class ADVISORY_AGENT,FINANCIAL_DATA_AGENT,MARKET_RESEARCH_AGENT agentLayer
    class MEMORY_MGR,TOOL_REGISTRY,EVENT_BUS,VOICE_ENGINE serviceLayer
    class MEM0_CORE,AGENT_MEMORIES,SHARED_INSIGHTS,USER_CONTEXT,VOICE_HISTORY memoryLayer
    class MCP_SERVER,PERPLEXITY_API,VERTEX_AI,SPEECH_API externalLayer
```
...
graph TB
    ...
    USER_QUERY[👤 User Query<br/>Voice/Text] --> FINANCE_GENIE[🧠 FinanceGenie Orchestrator]
    ...
    subgraph "MULTI-AGENT MEMORY SYSTEM"
        subgraph "Agent-Specific Memories"
            ...
            VOICE_MEM[🎙️ Voice Interaction Memory<br/>• Conversation History<br/>• Voice Preferences<br/>• Context Continuity]
        end
    ...
    RESPONSE_SYNTHESIS --> ENHANCED_RESPONSE[✨ Enhanced Multi-Agent Response<br/>Voice/Text Output]
    ...
    class ADVISORY_AGENT,FINANCIAL_DATA_AGENT,MARKET_RESEARCH_AGENT agentLayer
    class ADVISORY_MEM,FINANCIAL_MEM,MARKET_MEM,VOICE_MEM,CROSS_AGENT_INSIGHTS,USER_CONTEXT_UNIFIED,INTERACTION_HISTORY,VECTOR_EMBEDDINGS,GRAPH_RELATIONSHIPS,TEMPORAL_INTELLIGENCE,SEMANTIC_ROUTING memoryLayer
...
graph TB
    ...
    subgraph "FRONTEND LAYER"
        ...
        VOICE_UI[🎙️ Voice Interface<br/>Speech Recognition]
    end
    ...
    subgraph "ORCHESTRATION LAYER"
        ...
        VOICE_ORCHESTRATOR[🎙️ Voice Orchestrator]
    end
    ...
    subgraph "AGENT LAYER"
        ...
        MCP_INTEGRATION[🔗 MCP Integration<br/>Financial Data Access]
    end
    ...
    subgraph "AI PROCESSING LAYER"
        ...
        SPEECH_PROCESSING[🎙️ Speech Processing<br/>Voice Recognition & Synthesis]
    end
    ...
    class REACT,AGENT_DASHBOARD,CHAT_INTERFACE,VOICE_UI frontend
    class LANGGRAPH_ORCH,TASK_ROUTING,RESPONSE_MERGER,CONFLICT_RESOLVER,VOICE_ORCHESTRATOR orchestration
    class LANGGRAPH_AGENTS,LANGCHAIN_TOOLS,AGENT_PROTOCOLS,MCP_INTEGRATION agents
    class MEM0_MULTI,NEO4J_GRAPH,VECTOR_STORE,REDIS_CACHE memory
    class VERTEX_AI_MULTI,GEMINI_ORCH,GEMINI_AGENTS,EMBEDDINGS_API,SPEECH_PROCESSING ai
